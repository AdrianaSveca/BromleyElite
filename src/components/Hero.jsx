      ...
      <div className="heroContent">
        ...
        <div className="heroInformation">
          <h1 className="heroTitle">
            Quality Flooring. <span>Expertly Fitted.</span>
          </h1>

          <p className="heroParagraph">
            Family-run flooring specialists with over 45 years of experience
            supplying and fitting quality flooring across Bromley and the
            surrounding areas.
          </p>
